...
#pragma warning restore CA2211 // Non-constant fields should not be visible
    ...
    {
        if (this.Controls.Contains(tablesView) == true) return;
                
        tablesView.CreateControl();
        Controls.Add(tablesView);
        tablesView.Location = new System.Drawing.Point(146, 31);
        tablesView.Tables = _comp.Tables;
        tablesView.LoadData();
    ...
    {
        _comp.Tables = this.tablesView.Tables;
    }
